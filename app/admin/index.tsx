    ...
    <ScreenContainer className="px-5 pt-3" edges={["top", "left", "right", "bottom"]}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 36 }}>
        <View className="gap-5">
          ...
          <View className="gap-2"><AppButton label="Criar trilha e primeiro nó" onPress={() => router.push("/admin/create")} /><AppButton label="Importar trilha JSON" variant="secondary" onPress={() => router.push("/admin/import")} /></View>
